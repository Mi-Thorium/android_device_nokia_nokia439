...
TARGET_KERNEL_RECOVERY_CONFIG += vendor/nokia/sdm439/nokia439.config
endif
...
# Partitions - dynamic
BOARD_SUPER_PARTITION_BLOCK_DEVICES := system_a system_b vendor_a vendor_b
BOARD_SUPER_PARTITION_METADATA_DEVICE := system_a
BOARD_SUPER_PARTITION_SYSTEM_A_DEVICE_SIZE := 3221225472
BOARD_SUPER_PARTITION_SYSTEM_B_DEVICE_SIZE := 3221225472
BOARD_SUPER_PARTITION_VENDOR_A_DEVICE_SIZE := 671088640
BOARD_SUPER_PARTITION_VENDOR_B_DEVICE_SIZE := 671088640
BOARD_SUPER_PARTITION_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_SYSTEM_A_DEVICE_SIZE) + $(BOARD_SUPER_PARTITION_SYSTEM_B_DEVICE_SIZE) + $(BOARD_SUPER_PARTITION_VENDOR_A_DEVICE_SIZE) + $(BOARD_SUPER_PARTITION_VENDOR_B_DEVICE_SIZE) )
